...
请开始回答："""
    ...
    def _build_field_glossary(self, calculation_steps: Any) -> str:
        ...
        field_glossary = {
            ...
            "mill_type": "水磨类型 (s_water_mill=小水磨, l_water_mill=大水磨)",
