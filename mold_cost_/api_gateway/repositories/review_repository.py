...
=== 文件合并信息 ===
合并日期: 2026-02-10
源文件: mold_cost_/api_gateway/repositories/review_repository.py (独有文件)
...
class ReviewRepository:
    ...
    async def update_subgraphs(
        ...
        allowed_fields = {
            ...
            'heat_treatment_cost', 'process_description', 'nc_roughing_time',
            'nc_milling_time', 'drilling_time', 'milling_machine_time',
            ...
            'total_cost', 'wire_process_note', 'nc_roughing_cost',
            'nc_milling_cost', 'drilling_cost', 'milling_machine_cost',
    ...
    def _convert_subgraph_types(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        float_fields = [
            ...
            'nc_roughing_time', 'nc_milling_time', 'drilling_time',
            'milling_machine_time', 'large_grinding_time', 'small_grinding_time', 'edm_time',
            'engraving_time', 'slow_wire_length', 'slow_wire_side_length',
            'mid_wire_length', 'fast_wire_length', 'total_cost',
            'nc_roughing_cost', 'nc_milling_cost', 'drilling_cost',
            'milling_machine_cost', 'large_grinding_cost', 'small_grinding_cost',
