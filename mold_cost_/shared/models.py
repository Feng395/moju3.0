...
class ReportSummary(Base):
    ...
    # 加工费合?
    total_nc_roughing_cost = Column(DECIMAL(12, 2))
    total_nc_milling_cost = Column(DECIMAL(12, 2))
    total_drilling_cost = Column(DECIMAL(12, 2))
    total_milling_machine_cost = Column(DECIMAL(12, 2))
