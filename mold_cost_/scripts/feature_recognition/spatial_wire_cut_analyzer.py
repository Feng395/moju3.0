...
class SpatialWireCutAnalyzer:
    ...
    def analyze_additional_wire_cut(
        ...
        if spatial_type == 'two_ends':
            return self._analyze_two_ends(instruction, unmatched_red_lines, view_bounds, view_name)
    ...
    def _analyze_two_ends(
        ...
        # 步骤2：识别"两头"的线
        two_end_lines = self._identify_two_ends_lines(merged_lines, view_bounds)
