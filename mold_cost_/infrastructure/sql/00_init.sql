...
COMMENT ON COLUMN "public"."features"."volume_mm3" IS '体积（立方毫米），从NC Agent的batch_meta.volume_data.volume_mm3提取';
...
CACHE 1
  ...
  "nc_z_cost" varchar(255) COLLATE "pg_catalog"."default",
  "nc_b_cost" varchar(255) COLLATE "pg_catalog"."default",
  "nc_c_cost" varchar(255) COLLATE "pg_catalog"."default",
  "nc_c_b_cost" varchar(255) COLLATE "pg_catalog"."default",
  "nc_z_view_cost" varchar(255) COLLATE "pg_catalog"."default",
  "nc_b_view_cost" varchar(255) COLLATE "pg_catalog"."default",
  "weight_price_steps" jsonb,
  "nc_base_cost" varchar(255) COLLATE "pg_catalog"."default",
...
COMMENT ON COLUMN "public"."processing_cost_calculation_details"."nc_z_cost" IS 'nc主视图时间';
COMMENT ON COLUMN "public"."processing_cost_calculation_details"."nc_b_cost" IS 'nc背面时间';
COMMENT ON COLUMN "public"."processing_cost_calculation_details"."nc_c_cost" IS 'nc侧面正面时间';
COMMENT ON COLUMN "public"."processing_cost_calculation_details"."nc_c_b_cost" IS 'nc侧背时间';
COMMENT ON COLUMN "public"."processing_cost_calculation_details"."nc_z_view_cost" IS 'nc正面时间';
COMMENT ON COLUMN "public"."processing_cost_calculation_details"."nc_b_view_cost" IS 'nc正面的背面时间';
COMMENT ON COLUMN "public"."processing_cost_calculation_details"."weight_price_steps" IS '重量计算价格步骤详情';
COMMENT ON COLUMN "public"."processing_cost_calculation_details"."nc_base_cost" IS 'nc基本时间';
...
CREATE TABLE "public"."subgraphs" (
  ...
  "nc_z_view_fee" numeric(12,2),
  "nc_b_view_fee" numeric(12,2),
...
CREATE VIEW "public"."v_subgraph_summary" AS  SELECT job_id,
    ...
    sum(nc_z_fee + nc_b_fee) AS total_nc_cost
   FROM subgraphs s
  GROUP BY job_id;
...
CREATE VIEW "public"."v_job_cost_summary" AS  SELECT j.job_id,
   ...
   FROM jobs j
     LEFT JOIN ( SELECT subgraphs.job_id,
            ...
            sum(subgraphs.nc_z_fee) AS nc_roughing_cost,
            sum(subgraphs.nc_b_fee) AS nc_milling_cost,
            sum(subgraphs.nc_c_fee) AS drilling_cost,
            sum(subgraphs.nc_c_b_fee) AS milling_machine_cost,
...
OWNED BY "public"."audit_logs"."audit_id";
SELECT setval('"public"."audit_logs_audit_id_seq1"', 1293, true);
...
SELECT setval('"public"."chat_messages_message_id_seq"', 11165, true);
...
SELECT setval('"public"."features_feature_id_seq"', 30697, true);
...
OWNED BY "public"."job_price_snapshots"."snapshot_id";
SELECT setval('"public"."job_price_snapshots_snapshot_id_seq1"', 127552, true);
...
OWNED BY "public"."operation_logs"."log_id";
SELECT setval('"public"."operation_logs_log_id_seq1"', 2781, true);
...
SELECT setval('"public"."processing_cost_calculation_details_detail_id_seq"', 181911, true);
