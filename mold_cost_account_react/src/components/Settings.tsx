        ...
        <div style={{ maxWidth: 640, margin: '0 auto' }}>
          <Space direction="vertical" style={{ width: '100%' }} size={24}>
            ...
            <Flex align="center" gap={12} style={{ marginBottom: 8 }}>
              <SettingOutlined style={{ fontSize: 24, color: token.colorText }} />
              <Text style={{ fontSize: 24, fontWeight: 600 }}>设置</Text>
            </Flex>
            {/* 用户信息卡片 */}
            <Card
          ...
          >
            <Flex align="center" justify="space-between">
              ...
              <RightOutlined style={{ fontSize: 16, color: token.colorTextTertiary }} />
            </Flex>
          </Card>
              ...
              <Flex justify="space-between" align="center">
                <Flex align="center" gap={12}>
                  {themeMode === 'light' ? (
                    ...
                    <MoonOutlined style={{ fontSize: 20, color: token.colorPrimary }} />
                  )}
                  <div>
                    <div style={{ 
                      fontSize: 14, 
            ...
            >
              <Flex align="center" gap={12}>
                <LogoutOutlined style={{ fontSize: 20, color: token.colorError }} />
                <div style={{ 
                  fontSize: 15, 
                  fontWeight: 500, 
      ...
      >
        {userInfo && (
          <Space direction="vertical" style={{ width: '100%' }} size={16}>
            ...
            <div>
              <Text type="secondary" style={{ fontSize: 13 }}>姓名</Text>
              <div style={{ 
                fontSize: 15, 
                marginTop: 4,
                background: '#F7F7F7',
